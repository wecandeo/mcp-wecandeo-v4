...
> - `@pluto90/wecandeo-v4-mcp` — 비디오팩 전반 기능 (본 서버)
> - `@pluto90/wecandeo-v4-analytics-mcp` — 통계
> - `@pluto90/wecandeo-v4-ai-mcp` — AI 기능
...
```bash
WECANDEO_API_KEY=your_key npx @pluto90/wecandeo-v4-mcp
```
...
```json
{
  "mcpServers": {
    "wecandeo-v4": {
      "command": "npx",
      "args": ["-y", "@pluto90/wecandeo-v4-mcp"],
      "env": {
